...
class UpVisitor: public Visitor // correspond to the implementation of UpVisitor for derived classes This, That, The Other
{
...
int main()
{
  ...
  for (int i = 0; i < 3; i++)
  //    and passes each
    list[i]->accept(up); // corresponding visit methods will be executed
  //    to accept() calls
  for (int i = 0; i < 3; i++)
    list[i]->accept(down);
}
